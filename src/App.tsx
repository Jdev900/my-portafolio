        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-auto">
          ...
          <header className={`md:col-span-8 ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-100'} border rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-8 shadow-sm transition-colors`}>
            ...
            <div className="text-center md:text-left">
              <h1 className={`text-3xl md:text-5xl tracking-tighter leading-tight mb-3 ${darkMode ? 'text-white' : 'text-slate-900'} transition-colors`}>
                Frontend Developer<br/>
                <span className="text-[29px] text-blue-400 calibri"> Ing. José Rodríguez</span><br/> 
              </h1>
